# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-08-13 19:51
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor_type', models.CharField(blank=True, choices=[('individual', 'Individual'), ('organization', 'Organization')], max_length=30)),
                ('is_visible', models.BooleanField(default=False, verbose_name='Agreed to displaying on the fundraising page?')),
                ('is_subscribed', models.BooleanField(default=False, verbose_name='Agreed to being contacted by CTS?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('donor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fundraising.CTSDonor')),
            ],
            options={
                'abstract': False,
            },
