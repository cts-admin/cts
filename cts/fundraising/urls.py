...
urlpatterns = [
    ...
    url(r'^manage-donations/(?P<donor>[\w]+)/$', views.manage_donations, name='manage-donations'),
    url(r'^manage-donations/(?P<donor>[\w]+)/cancel/$', views.cancel_donation, name='cancel-donation'),
